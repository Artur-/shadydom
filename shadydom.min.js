...
module$$src$utils.mixin=mixin$$module$$src$utils;module$$src$utils.patchPrototype=patchPrototype$$module$$src$utils;module$$src$utils.microtask=microtask$$module$$src$utils;var module$$src$flush={},flushList$$module$$src$flush=[],scheduled$$module$$src$flush;function enqueue$$module$$src$flush(a){scheduled$$module$$src$flush||(scheduled$$module$$src$flush=!0,module$$src$utils.microtask(flush$$module$$src$flush));flushList$$module$$src$flush.push(a)}function flush$$module$$src$flush(){scheduled$$module$$src$flush=!1;for(var a=!!flushList$$module$$src$flush.length;flushList$$module$$src$flush.length;)flushList$$module$$src$flush.shift()();return a}
...
function setAttribute$$module$$src$logical_mutation(a,b,c){window.ScopingShim&&"class"===b&&a.ownerDocument===document?window.ScopingShim.setElementClass(a,c):(module$$src$native_methods.setAttribute.call(a,b,c),distributeAttributeChange$$module$$src$logical_mutation(a,b))}function removeAttribute$$module$$src$logical_mutation(a,b){module$$src$native_methods.removeAttribute.call(a,b);distributeAttributeChange$$module$$src$logical_mutation(a,b)}
